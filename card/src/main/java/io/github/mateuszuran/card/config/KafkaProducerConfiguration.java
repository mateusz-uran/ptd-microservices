package io.github.mateuszuran.card.config;
...
public class KafkaProducerConfiguration {
    ...
    @Bean
    public ProducerFactory<String, CardToggledEvent> greetingProducerFactory() {
    ...
    @Bean
    public KafkaTemplate<String, CardToggledEvent> greetingKafkaTemplate() {
