                    ...
                    <div className="justify-center items-center flex overflow-x-hidden overflow-y-auto fixed inset-0 z-50 outline-none focus:outline-none">
                        <div className="relative w-auto my-6 mx-auto max-w-1xl">
                            <div className="pt-2 rounded relative flex flex-col items-center bg-white dark:bg-slate-800">
                                <div className="flex h-9 w-9 items-center justify-center rounded-full bg-gradient-to-tr from-blue-500 dark:from-slate-400 animate-spin">
                                    <div className="h-7 w-7 rounded-full bg-white dark:bg-slate-800"></div>
                                </div>
                                {/*body*/}
